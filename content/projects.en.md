...
### BOARR : A benchmark for obstacle avoidance for drones
Created during my thesis, it is the first of its kind in aerial robotics. 
Its main goal is to main purpose is to test and compare the multiple existing avoidance algorithm 
for quadrotors with the hope that comparing the results could help choosing promising directions 
for future developments on autonomous obstacle avoidance. 
For more information, I redirect yourself to the dedicated 
[Github repository](https://github.com/Gipsa-lab-PFP/BOARR "The BOARR Github Repo"). 
 
 [![Video of a flight in BOARR](http://img.youtube.com/vi/F9KkQlTELVI/0.jpg)](http://www.youtube.com/watch?v=F9KkQlTELVI)
